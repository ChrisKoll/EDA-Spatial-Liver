...
Observations @plot-transcript-map:
...
```{r}
#| label: validate-nCount-Nanostring
#| tbl-cap: |
...
In @validate-nCount-Nanostring we see that `nCount_Nanostring` is equal to sum 
of counts for each individual cell.

##### Descriptive Statistics

```{r}
#| label: descriptive-statistics-cell-counts
#| tbl-cap: |
...
```{r}
#| label: plot-cell-counts-density
#| fig-cap: |
...
pdata_counts_per_cell <- cell_counts_dist_l1 |>
  dplyr::bind_rows(cell_count_dists_l2)
...
Observations @plot-cell-counts-density:
...
Observations @plot-cell-counts-violin:
...
Observations @plot-cell-counts-ECDF:
...
```{r}
#| label: validate-nFeature-Nanostring
#| tbl-cap: |
...
In @validate-nFeature-Nanostring we see that `nFeature_Nanostring` is equal to 
sum of of all non-zero features for each individual cell.

##### Descriptive Statistics

```{r}
#| label: descriptive-statistics-feature-counts
#| tbl-cap: |
...
```{r}
#| label: plot-cell-features-density
...
Observations @plot-cell-features-density:
...
```{r}
#| label: descriptive-statistics-gene-counts
#| tbl-cap: |
...
```{r}
#| label: plot-gene-counts-density
#| fig-cap: |
...
Observations @plot-gene-counts-density:
...
```{r}
#| label: precalculated-umap-slide
...
Observations @precalc-umap-disease-state:
...
Observations @precalc-umap-cell-type:
...
```{r}
#| label: plot-density-disease-state
...
Observations @plot-density-disease-state:
...
```{r}
#| label: plot-density-cells-per-fov
...
Observations @plot-density-cells-per-fov:
